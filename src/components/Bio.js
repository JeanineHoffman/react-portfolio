    ...
    return (
      <div className="About">
        <article className="bio" arial-label="biography section">
          ...
          As a Timbers and Thorns fan, I joined the 107ist Supporters group. I spend some of my time giving back to the community through volunteer activities that support the growth of soccer and equality throughout our area.The 107ist supporters pull together as a team, which is something I've found I enjoy taking part in during my experiance with Thinkful's Enigneering Immersion team approach. </p>
          <p className="aboutText">
