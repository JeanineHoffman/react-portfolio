  ...
  render() {
    ...
    <article className="projectSection" aria-label="projects section">
      <div className="project1">
       ...
       className="project2btn"
       aria-label="quiz button">Try it</a>
        <a href="https://github.com/JeanineHoffman/City-Look-Up" target="_blank" rel="noopener noreferrer" className="project2btn" aria-label="button to code review">Code</a>
      </div>
      </div>
      <div className="project2">
        ...
        <a href="https://github.com/JeanineHoffman/LesFic-Rate-Your-Reads.git" target="_blank" rel="noopener noreferrer" className="projectbtn" aria-label="button to code review">Client Code</a>
        <a href="https://github.com/JeanineHoffman/lesfic-server.git" target="_blank" rel="noopener noreferrer" className="projectbtn" aria-label="button to code review">Server Code</a>
        </div>
      </div>
      <div className="project3">
        ...
        <p className="proj3">This was a team Capstone project during which I worked as project manager for my five person team. We thankfully had a team member well versed in design. In three weeks we managed to do a pretty extensive app involving predictive text search, building a multi table database, public and private routing, JWT auth, and integrated the use of Cloudinary and Google Maps API. Our demo is available with the user name and password of Demo.</p>
        <div className="projWrapper">
        <a href="https://toolbox-client-git-master.teamredpanda.now.sh/" target="_blank" rel="noopener noreferrer" className="projectbtn" aria-label="Toolbox app button">Try it</a>
        <a href="https://github.com/CommunityTB/toolbox-client.git" target="_blank" rel="noopener noreferrer" className="projectbtn" aria-label="button to code review">Client Code</a>
        <a href="https://github.com/CommunityTB/toolbox-server.git" target="_blank" rel="noopener noreferrer"
        className="projectbtn" aria-label="button to code review">Server Code</a>
      </div>
      </div>
    </article>
    </div>
