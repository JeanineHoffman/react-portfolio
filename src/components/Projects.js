    ...
    return (
      <div className="projWrapper">
        ...
        <div className="project3">
          ...
          <p className="proj3"> The Community Toolbox is an app that allows community-run lending libraries to work more efficiently in their areas. With slight adaptations the app is designed to help users find the tools they need for home improvement and garden/lawn care tasks without the investment cost and need for storage of seldom used, bulky tools.</p>
          <p className="proj3">This was a team Capstone project during which I worked as project manager for my five person team. We thankfully had a team member well versed in design. In three weeks we managed to do a pretty extensive app involving predictive text search, building a multi table database, public and private routing, JWT auth, and integrated the use of Cloudinary and Google Maps API. Our demo is available with the user name and password as Demo.</p>
          <div className="btnWrap">
