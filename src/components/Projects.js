...
export default class Projects extends Component {
  render() {
    ...
    <article className="projectSection" aria-label="projects section">
      <div className="proj">
        <h3 className="projTitle">City-Look Up</h3>
        ...
        <a href=" https://jeaninehoffman.github.io/City-Look-Up/" target="_blank" rel="noopener noreferrer"><button className="projectsnavbtn" type="button" aria-label="quiz button">Give it a shot</button></a>
        <a href="https://github.com/JeanineHoffman/City-Look-Up" target="_blank" rel="noopener noreferrer"><button type="button" className="projectCodebtn" aria-label="button to code review">Code for App</button></a>
      </div>
      <div className="proj2">
        <h3 className="projTitle">Lesfic Repository</h3>
        ...
        <a href="https://lesfic-rate-your-reads-git-master.jeaninehoffman.now.sh/" target="_blank" rel="noopener noreferrer"><button className="projectsnavbtn" type="button" aria-label="lesfic app button">Give it a shot</button></a>
        <a href="https://github.com/JeanineHoffman/LesFic-Rate-Your-Reads.git" target="_blank" rel="noopener noreferrer"><button type="button" className="projectCodebtn" aria-label="button to code review">Client Code</button></a>
        <a href="https://github.com/JeanineHoffman/lesfic-server.git" target="_blank" rel="noopener noreferrer"><button type="button" className="projectCodebtn" aria-label="button to code review">Server Code</button></a>
      </div>
      <div className="proj3">
        ...
        <a href="https://toolbox-client-git-master.teamredpanda.now.sh/" target="_blank" rel="noopener noreferrer"><button className="projectsnavbtn" type="button" aria-label="Toolbox app button">Give it a shot</button></a>
        <a href="https://github.com/CommunityTB/toolbox-client.git" target="_blank" rel="noopener noreferrer"><button type="button" className="projectCodebtn" aria-label="button to code review">Client Code</button></a>
        <a href="https://github.com/CommunityTB/toolbox-server.git" target="_blank" rel="noopener noreferrer"><button type="button" className="projectCodebtn" aria-label="button to code review">Server Code</button></a>
      </div>
    </article>
    </div>
  );
