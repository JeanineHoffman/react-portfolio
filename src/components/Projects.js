  ...
  return (
    <article className="projectSection" aria-label="projects section">
      <div className="proj1">
        ...
        <img class="projimg" src={City} alt="city skyline." title="cityscape" />
      ...
      <div className="proj2">
        ...
        <img class="projimg" src={LesficRepo} alt="Lesfic Repository landing page" title="Lesfic Repository" />
      ...
      <div className="proj3">
        ...
        <img class="projimg" src={Toolbox} alt="Screenshot of The Community Toolbox app" title="The Community Toolbox" />
